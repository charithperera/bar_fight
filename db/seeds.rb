...
specials = ["Hot Chocolate", "Nosiness", "Gadgets", "Sleepless", "Parrots", "Wisdom", "Mr Music", "Sasquatch Fancier", "Wordsmith", "Calorie King", "Tree Whisperer", "Beer Connoisseur", "Normal Man", "Enthusiasm", "Magician", "Artist", "Batman", "Nice Hair Nice House", "Poker Face", "Smiley", "Mr Suave", "Delinquent", "Patience", "Cakepudding", "B.O.S.S"]
